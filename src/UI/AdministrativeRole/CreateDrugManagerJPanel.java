 ...
 * @author Aayush
 */
public class CreateDrugManagerJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CreateDrugManagerJPanel
     */
    private JPanel userProcessContainer;
    private Enterprise enterprise;
    private Organization drugMngrOrg;

    public CreateDrugManagerJPanel(JPanel upc, Enterprise enterprise) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for (UserAccount userAccount : drugMngrOrg.getUserAccountDirectory().getUserAccountList()) {
            if (userAccount.getRole() instanceof DrugManagerRole) {
    ...
    private void submitjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitjButton1ActionPerformed
        ...
        if (!(userName.isEmpty() || password.isEmpty() || fname.isEmpty() || lname.isEmpty() || gender.isEmpty()
            ...
            Person person = new Person();
                ...
                UserAccount userAccount = drugMngrOrg.getUserAccountDirectory().createUserAccount(userName, password, person, new DrugManagerRole());
                ...
                drugMngrOrg.getPersonDirectory().createPerson(person);
                populateTable();
            } else {
    ...
    private void deletejButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletejButton2ActionPerformed
        ...
        if (row < 0) {
            ...
            if (selectedValue == JOptionPane.YES_OPTION) {
                ...
                drugMngrOrg.getPersonDirectory().getPersonList().remove(person);

                UserAccount ua = (UserAccount) drugManagerJTable.getValueAt(row, 2);
                drugMngrOrg.getUserAccountDirectory().getUserAccountList().remove(ua);
