 ...
 * @author Aayush
 */
public class ManageICDemployee extends javax.swing.JPanel {

    /**
     * Creates new form ManageICDemployee
     */
    private JPanel userProcessContainer;
    private Organization iCDOrg;

    public ManageICDemployee(JPanel userProcessContainer, Organization iCDOrg) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for (UserAccount userAccount : iCDOrg.getUserAccountDirectory().getUserAccountList()) {
            if (userAccount.getRole() instanceof ICDRole) {
    ...
    private void submitjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitjButton1ActionPerformed
        ...
        if (!(userName.isEmpty() || password.isEmpty() || fname.isEmpty() || lname.isEmpty() || gender.isEmpty()
            ...
            UserAccount userAccount = iCDOrg.getUserAccountDirectory().createUserAccount(userName, password, person, new ICDRole());
            ...
            iCDOrg.getPersonDirectory().createPerson(person);
            populateTable();
        } else {
    ...
    private void deletejButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletejButton2ActionPerformed
        ...
        if (row < 0) {
            ...
            if (selectedValue == JOptionPane.YES_OPTION) {
                ...
                iCDOrg.getPersonDirectory().getPersonList().remove(person);

                UserAccount ua = (UserAccount) drugManagerJTable.getValueAt(row, 2);
                iCDOrg.getUserAccountDirectory().getUserAccountList().remove(ua);
